...
parser.add_argument(
    "--video",
    default="Videos/FULL MATCH  Manchester City vs Chelsea  Final  Exclusive VIP Tactical Camera HD 1080p  2021 .MOV",
    type=str,
    help="Path to the input video",
)
parser.add_argument(
    "--model", default="yolov5x.pt", type=str, help="Path to the model"
)
parser.add_argument(
    "--passes",
    action="store_true",
